...
from cellpose.Mobile.models.vit_tiny import (
    SAMStyleTinyViTEncoder,
    SAMStyleTinyViTDecoder,
)
...
def create_cellpose_model(student_encoder, student_decoder, device="cuda"):
    ...
    model = CellposeCustomModel(
        gpu=True, nchan=3, use_bfloat16=False, custom_net=tiny_network
    )
    return model
